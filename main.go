...
var (
	...
	s3ScanEndpoint      = s3Scan.Flag("endpoint", "Custom endpoint URL for S3-compatible providers (e.g. https://s3.wasabisys.com). If unset, the default AWS endpoints are used.").String()
