...
var (
	...
	gitlabScanProjectID = gitlabScan.Flag("project-id", "GitLab project ID.").Int()
	gitlabScanProjectPath = gitlabScan.Flag("project-path", "GitLab project path (e.g., 'namespace/project').").String()
