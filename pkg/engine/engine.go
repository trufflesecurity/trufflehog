...
type Config struct {
	...
	AllowlistedSecrets    *detectors.CompiledAllowlist
...
func (e *Engine) filterResults(
	...
	if e.allowlistedSecrets != nil && (len(e.allowlistedSecrets.ExactMatches) > 0 || len(e.allowlistedSecrets.CompiledRegexes) > 0) {
