...
var file_sources_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x5c, 0x0a, 0x0e, 0x47, 0x69, 0x74, 0x48, 0x75, 0x62, 0x52,
	0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x6c, 0x69, 0x73, 0x74, 0x65,
	0x6e, 0x65, 0x72, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c,
	0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x25, 0x0a, 0x0e,
	...
	0x72, 0x65, 0x74, 0x22, 0x42, 0x0a, 0x0b, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x44, 0x72, 0x69,
	...
	0x45, 0x41, 0x4c, 0x54, 0x49, 0x4d, 0x45, 0x10, 0x27, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74,
...
var file_sources_proto_depIdxs = []int32{
	...
	42, // 25: sources.Huggingface.unauthenticated:type_name -> credentials.Unauthenticated
	41, // 26: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	42, // 27: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	43, // 28: sources.JIRA.oauth:type_name -> credentials.Oauth2
	42, // 29: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	42, // 30: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	44, // 31: sources.S3.access_key:type_name -> credentials.KeySecret
	42, // 32: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	45, // 33: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	48, // 34: sources.S3.session_token:type_name -> credentials.AWSSessionTokenSecret
	49, // 35: sources.Slack.tokens:type_name -> credentials.SlackTokens
	41, // 36: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	42, // 37: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	41, // 38: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	50, // 39: sources.Jenkins.header:type_name -> credentials.Header
	42, // 40: sources.Jenkins.unauthenticated:type_name -> credentials.Unauthenticated
	51, // 41: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	43, // 42: sources.Teams.oauth:type_name -> credentials.Oauth2
	42, // 43: sources.Forager.unauthenticated:type_name -> credentials.Unauthenticated
	52, // 44: sources.Forager.since:type_name -> google.protobuf.Timestamp
	49, // 45: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
	43, // 46: sources.Sharepoint.oauth:type_name -> credentials.Oauth2
	43, // 47: sources.AzureRepos.oauth:type_name -> credentials.Oauth2
	42, // 48: sources.Postman.unauthenticated:type_name -> credentials.Unauthenticated
	50, // 49: sources.Webhook.header:type_name -> credentials.Header
