...
const (
	...
	SourceType_SOURCE_TYPE_FILE                       SourceType = 28
)
...
var file_sources_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x1a, 0x0a, 0x04, 0x46,
	0x69, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x48, 0x0a, 0x03, 0x47, 0x43, 0x53, 0x12, 0x19,
	...
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x2a, 0xaf, 0x06, 0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x10, 0x1b, 0x12, 0x14, 0x0a, 0x10, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x46, 0x49, 0x4c, 0x45, 0x10, 0x1c, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68,
...
var file_sources_proto_depIdxs = []int32{
	...
	33, // 13: sources.GitLab.oauth:type_name -> credentials.Oauth2
	31, // 14: sources.GitLab.basic_auth:type_name -> credentials.BasicAuth
	35, // 15: sources.GitHub.github_app:type_name -> credentials.GitHubApp
	32, // 16: sources.GitHub.unauthenticated:type_name -> credentials.Unauthenticated
	31, // 17: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	32, // 18: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	33, // 19: sources.JIRA.oauth:type_name -> credentials.Oauth2
	32, // 20: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	32, // 21: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	34, // 22: sources.S3.access_key:type_name -> credentials.KeySecret
	32, // 23: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	36, // 24: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	37, // 25: sources.Slack.tokens:type_name -> credentials.SlackTokens
	...
	38, // 29: sources.Jenkins.header:type_name -> credentials.Header
	39, // 30: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	31, // 31: sources.Artifactory.basic_auth:type_name -> credentials.BasicAuth
	32, // 32: sources.PublicEventMonitoring.unauthenticated:type_name -> credentials.Unauthenticated
	40, // 33: sources.PublicEventMonitoring.since:type_name -> google.protobuf.Timestamp
	37, // 34: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
