...
var file_sources_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x82, 0x01, 0x0a, 0x0a, 0x53, 0x68, 0x61, 0x72, 0x65, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x72, 0x03, 0x90, 0x01, 0x01,
	0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x25, 0x0a, 0x0d, 0x72, 0x65,
	...
	0x6e, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x69, 0x74, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x69, 0x74, 0x65, 0x55, 0x72, 0x6c, 0x42, 0x0c, 0x0a, 0x0a,
	0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x2a, 0xf1, 0x06, 0x0a, 0x0a, 0x53,
	...
	0x46, 0x4c, 0x55, 0x45, 0x4e, 0x43, 0x45, 0x10, 0x03, 0x12, 0x20, 0x0a, 0x1c, 0x53, 0x4f, 0x55,
	0x52, 0x43, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x44, 0x4f, 0x43, 0x4b, 0x45, 0x52, 0x48,
	0x55, 0x42, 0x5f, 0x49, 0x4d, 0x41, 0x47, 0x45, 0x53, 0x10, 0x04, 0x12, 0x13, 0x0a, 0x0f, 0x53,
...
var file_sources_proto_depIdxs = []int32{
	...
	39, // 29: sources.Slack.tokens:type_name -> credentials.SlackTokens
	32, // 30: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	33, // 31: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	32, // 32: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	40, // 33: sources.Jenkins.header:type_name -> credentials.Header
	41, // 34: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	34, // 35: sources.Teams.oauth:type_name -> credentials.Oauth2
	32, // 36: sources.Artifactory.basic_auth:type_name -> credentials.BasicAuth
	33, // 37: sources.PublicEventMonitoring.unauthenticated:type_name -> credentials.Unauthenticated
	42, // 38: sources.PublicEventMonitoring.since:type_name -> google.protobuf.Timestamp
	39, // 39: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
