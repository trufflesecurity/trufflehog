...
const (
	...
	SourceType_SOURCE_TYPE_LOGSTASH                   SourceType = 35
)
...
func (x *Logstash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Logstash) ProtoMessage() {}

func (x *Logstash) ProtoReflect() protoreflect.Message {
	mi := &file_sources_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Logstash.ProtoReflect.Descriptor instead.
func (*Logstash) Descriptor() ([]byte, []int) {
	return file_sources_proto_rawDescGZIP(), []int{32}
}

func (x *Logstash) GetCloudId() string {
	if x != nil {
		return x.CloudId
	}
	return ""
...
func (x *Logstash) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
var file_sources_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x3e, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x73,
	0x74, 0x61, 0x73, 0x68, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5f, 0x69, 0x64,
	...
	0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x2a, 0xea, 0x07, 0x0a, 0x0a, 0x53, 0x6f, 0x75,
	...
	0x45, 0x5f, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x10, 0x22, 0x12, 0x18, 0x0a, 0x14, 0x53,
	0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4c, 0x4f, 0x47, 0x53, 0x54,
	0x41, 0x53, 0x48, 0x10, 0x23, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_sources_proto_goTypes = []interface{}{
	...
	(*Logstash)(nil),                            // 34: sources.Logstash
