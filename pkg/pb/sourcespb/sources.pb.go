...
var file_sources_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x61, 0x6c, 0x22, 0xfa, 0x01, 0x0a, 0x06, 0x47, 0x69, 0x74, 0x4c, 0x61, 0x62, 0x12,
	...
	0x69, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x69, 0x64, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x69, 0x64, 0x73, 0x42, 0x0c, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61,
...
var file_sources_proto_goTypes = []interface{}{
	...
	(*credentialspb.SlackTokens)(nil),       // 35: credentials.SlackTokens
	(*credentialspb.Header)(nil),            // 36: credentials.Header
...
var file_sources_proto_depIdxs = []int32{
	...
	35, // 25: sources.Slack.tokens:type_name -> credentials.SlackTokens
	29, // 26: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	30, // 27: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	29, // 28: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	36, // 29: sources.Jenkins.header:type_name -> credentials.Header
	...
	30, // 32: sources.PublicEventMonitoring.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 33: sources.PublicEventMonitoring.since:type_name -> google.protobuf.Timestamp
