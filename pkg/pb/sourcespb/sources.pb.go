...
var file_sources_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x61, 0x6c, 0x22, 0xe3, 0x02, 0x0a, 0x06, 0x47, 0x69, 0x74, 0x48, 0x75, 0x62, 0x12,
	...
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x46, 0x6f, 0x72, 0x6b, 0x73, 0x42, 0x0c, 0x0a, 0x0a,
	...
	0x6c, 0x2a, 0xfe, 0x04, 0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65,
	...
	0x10, 0x16, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_sources_proto_goTypes = []interface{}{
	...
	(*credentialspb.BasicAuth)(nil),        // 25: credentials.BasicAuth
	(*credentialspb.Unauthenticated)(nil),  // 26: credentials.Unauthenticated
	(*credentialspb.Oauth2)(nil),           // 27: credentials.Oauth2
	(*credentialspb.KeySecret)(nil),        // 28: credentials.KeySecret
	(*credentialspb.GitHubApp)(nil),        // 29: credentials.GitHubApp
	(*credentialspb.CloudEnvironment)(nil), // 30: credentials.CloudEnvironment
	(*credentialspb.Header)(nil),           // 31: credentials.Header
}
var file_sources_proto_depIdxs = []int32{
	23, // 0: sources.LocalSource.scan_interval:type_name -> google.protobuf.Duration
	24, // 1: sources.LocalSource.connection:type_name -> google.protobuf.Any
	25, // 2: sources.AzureStorage.basic_auth:type_name -> credentials.BasicAuth
	26, // 3: sources.AzureStorage.unauthenticated:type_name -> credentials.Unauthenticated
	27, // 4: sources.Bitbucket.oauth:type_name -> credentials.Oauth2
	25, // 5: sources.Bitbucket.basic_auth:type_name -> credentials.BasicAuth
	26, // 6: sources.Confluence.unauthenticated:type_name -> credentials.Unauthenticated
	25, // 7: sources.Confluence.basic_auth:type_name -> credentials.BasicAuth
	1,  // 8: sources.Confluence.spaces_scope:type_name -> sources.Confluence.GetAllSpacesScope
	26, // 9: sources.DockerHub.unauthenticated:type_name -> credentials.Unauthenticated
	28, // 10: sources.ECR.access_key:type_name -> credentials.KeySecret
	25, // 11: sources.Git.basic_auth:type_name -> credentials.BasicAuth
	26, // 12: sources.Git.unauthenticated:type_name -> credentials.Unauthenticated
	27, // 13: sources.GitLab.oauth:type_name -> credentials.Oauth2
	25, // 14: sources.GitLab.basic_auth:type_name -> credentials.BasicAuth
	29, // 15: sources.GitHub.github_app:type_name -> credentials.GitHubApp
	26, // 16: sources.GitHub.unauthenticated:type_name -> credentials.Unauthenticated
	25, // 17: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	26, // 18: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	27, // 19: sources.JIRA.oauth:type_name -> credentials.Oauth2
	26, // 20: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	26, // 21: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	28, // 22: sources.S3.access_key:type_name -> credentials.KeySecret
	26, // 23: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	30, // 24: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	25, // 25: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	26, // 26: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	25, // 27: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	31, // 28: sources.Jenkins.header:type_name -> credentials.Header
