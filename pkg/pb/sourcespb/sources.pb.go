...
const (
	...
	SourceType_SOURCE_TYPE_NPM                        SourceType = 11
...
type NPM struct {
	...
	// Types that are assignable to Credential:
	//	*NPM_Unauthenticated
	Credential           isNPM_Credential `protobuf_oneof:"credential"`
	...
	NpmLockFileContents  string           `protobuf:"bytes,4,opt,name=npm_lock_file_contents,json=npmLockFileContents,proto3" json:"npm_lock_file_contents,omitempty"`
	YarnLockFileContents string           `protobuf:"bytes,5,opt,name=yarn_lock_file_contents,json=yarnLockFileContents,proto3" json:"yarn_lock_file_contents,omitempty"`
}
...
func (m *NPM) GetCredential() isNPM_Credential {
	if m != nil {
		return m.Credential
	}
	return nil
...
func (x *NPM) GetUnauthenticated() *credentialspb.Unauthenticated {
	if x, ok := x.GetCredential().(*NPM_Unauthenticated); ok {
		return x.Unauthenticated
	}
	return nil
}

func (x *NPM) GetPackages() []string {
	if x != nil {
		return x.Packages
	}
	return nil
...
func (x *NPM) GetMaintainers() []string {
	if x != nil {
...
func (x *NPM) GetNpmLockFileContents() string {
	if x != nil {
		return x.NpmLockFileContents
	}
	return ""
}

func (x *NPM) GetYarnLockFileContents() string {
	if x != nil {
		return x.YarnLockFileContents
	}
	return ""
}

type isNPM_Credential interface {
	isNPM_Credential()
}

type NPM_Unauthenticated struct {
	Unauthenticated *credentialspb.Unauthenticated `protobuf:"bytes,1,opt,name=unauthenticated,proto3,oneof"`
}

func (*NPM_Unauthenticated) isNPM_Credential() {}
...
type PyPI struct {
	...
	// Types that are assignable to Credential:
	//	*PyPI_Unauthenticated
	Credential isPyPI_Credential `protobuf_oneof:"credential"`
}
...
func (m *PyPI) GetCredential() isPyPI_Credential {
	if m != nil {
		return m.Credential
	}
	return nil
...
func (x *PyPI) GetUnauthenticated() *credentialspb.Unauthenticated {
	if x, ok := x.GetCredential().(*PyPI_Unauthenticated); ok {
		return x.Unauthenticated
	}
	return nil
}

type isPyPI_Credential interface {
	isPyPI_Credential()
}

type PyPI_Unauthenticated struct {
	Unauthenticated *credentialspb.Unauthenticated `protobuf:"bytes,1,opt,name=unauthenticated,proto3,oneof"`
}

func (*PyPI_Unauthenticated) isPyPI_Credential() {}
...
var file_sources_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x2e, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x65, 0x73,
	...
	0x63, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x48, 0x0a, 0x03, 0x47, 0x43, 0x53, 0x12, 0x19,
	0x0a, 0x07, 0x6a, 0x73, 0x6f, 0x6e, 0x5f, 0x73, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x00, 0x52, 0x06, 0x6a, 0x73, 0x6f, 0x6e, 0x53, 0x61, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x75, 0x63,
	...
	0x6c, 0x22, 0x8f, 0x02, 0x0a, 0x03, 0x47, 0x69, 0x74, 0x12, 0x37, 0x0a, 0x0a, 0x62, 0x61, 0x73,
	...
	0x69, 0x61, 0x6c, 0x22, 0x81, 0x02, 0x0a, 0x06, 0x47, 0x69, 0x74, 0x4c, 0x61, 0x62, 0x12, 0x24,
	...
	0x6e, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x42, 0x0c, 0x0a, 0x0a, 0x63, 0x72, 0x65,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xd1, 0x03, 0x0a, 0x06, 0x47, 0x69, 0x74, 0x48,
	...
	0x74, 0x65, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	...
	0x09, 0x52, 0x04, 0x62, 0x61, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x69, 0x67, 0x6e, 0x6f, 0x72,
	0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x69, 0x67,
	0x6e, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x69, 0x6e, 0x63,
	0x6c, 0x75, 0x64, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0c, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x42, 0x0c, 0x0a,
	0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x9e, 0x02, 0x0a, 0x04,
	0x4a, 0x49, 0x52, 0x41, 0x12, 0x24, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xc3, 0x01, 0x0a, 0x05, 0x53, 0x6c, 0x61, 0x63, 0x6b,
	...
	0x0a, 0x0a, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xdb, 0x01, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72,
	...
	0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xa5, 0x01, 0x0a, 0x07, 0x4a, 0x65, 0x6e, 0x6b, 0x69, 0x6e,
	...
	0x0c, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xf0, 0x01,
	...
	0x67, 0x6e, 0x6f, 0x72, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x65, 0x61,
	...
	0x22, 0xc3, 0x01, 0x0a, 0x0b, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79,
	0x12, 0x24, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x72, 0x03, 0x90, 0x01, 0x01, 0x52, 0x08, 0x65, 0x6e,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x22, 0xd6, 0x01,
	0x0a, 0x15, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x6f, 0x6e,
	0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x48, 0x0a, 0x0f, 0x75, 0x6e, 0x61, 0x75, 0x74,
	...
	0x09, 0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x61, 0x78,
	...
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x2a, 0x88, 0x06, 0x0a, 0x0a, 0x53, 0x6f,
	...
	0x4a, 0x49, 0x52, 0x41, 0x10, 0x0a, 0x12, 0x13, 0x0a, 0x0f, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45,
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4e, 0x50, 0x4d, 0x10, 0x0b, 0x12, 0x25, 0x0a, 0x21, 0x53,
	...
	0x4d, 0x45, 0x10, 0x1b, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_sources_proto_goTypes = []interface{}{
	...
	(*NPM)(nil),                             // 15: sources.NPM
	(*PyPI)(nil),                            // 16: sources.PyPI
...
var file_sources_proto_depIdxs = []int32{
	...
	31, // 21: sources.NPM.unauthenticated:type_name -> credentials.Unauthenticated
	31, // 22: sources.PyPI.unauthenticated:type_name -> credentials.Unauthenticated
