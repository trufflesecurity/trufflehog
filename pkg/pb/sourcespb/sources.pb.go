...
func (x *GoogleDrive) GetUseTokenService() bool {
	if x != nil {
		if x, ok := x.Credential.(*GoogleDrive_UseTokenService); ok {
...
func (x *GoogleDrive) GetOauth() *credentialspb.Oauth2 {
	if x != nil {
		if x, ok := x.Credential.(*GoogleDrive_Oauth); ok {
			return x.Oauth
		}
	}
	return nil
...
func (x *GoogleDrive) GetDwd() *credentialspb.GoogleDriveDWD {
	if x != nil {
		if x, ok := x.Credential.(*GoogleDrive_Dwd); ok {
			return x.Dwd
		}
	}
	return nil
...
type Elasticsearch struct {
	...
	BearerToken    string                 `protobuf:"bytes,11,opt,name=bearer_token,json=bearerToken,proto3" json:"bearer_token,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Elasticsearch) GetBearerToken() string {
	if x != nil {
		return x.BearerToken
	}
	return ""
...
const file_sources_proto_rawDesc = "" +
	...
	"\x11installation_type\x18\t \x01(\x0e2\".sources.BitbucketInstallationTypeR\x10installationType\x12@\n" +
	"\x1coauth_authorization_endpoint\x18\n" +
	" \x01(\tR\x1aoauthAuthorizationEndpoint\x120\n" +
	"\x14oauth_token_endpoint\x18\v \x01(\tR\x12oauthTokenEndpoint\x12!\n" +
	"\foauth_scopes\x18\f \x03(\tR\voauthScopes\x12=\n" +
	"\x1ballow_secrets_manager_write\x18\r \x01(\bR\x18allowSecretsManagerWriteB\f\n" +
	"\n" +
	"credential\"V\n" +
	"\bCircleCI\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x12\x16\n" +
	...
	"\fskip_history\x18\n" +
	" \x01(\bR\vskipHistory\x12)\n" +
	"\x10include_comments\x18\v \x01(\bR\x0fincludeComments\"6\n" +
	...
	"\rexclude_paths\x18\x06 \x03(\tR\fexcludePaths\x12\x1c\n" +
	"\tnamespace\x18\a \x01(\tR\tnamespace\x12%\n" +
	"\x0eregistry_token\x18\b \x01(\tR\rregistryTokenB\f\n" +
	"\n" +
	"credential\"l\n" +
	"\x03ECR\x127\n" +
	"\n" +
	...
	"\x12exclude_paths_file\x18\x04 \x01(\tR\x10excludePathsFile\x12#\n" +
	"\rskip_binaries\x18\x05 \x01(\bR\fskipBinaries\x12*\n" +
	"\x11max_symlink_depth\x18\x06 \x01(\x05R\x0fmaxSymlinkDepth\"\xab\x04\n" +
	"\x03GCS\x122\n" +
	...
	"\rskip_archives\x18\x0f \x01(\bR\fskipArchives\x12\x1d\n" +
	"\n" +
	"clone_path\x18\x10 \x01(\tR\tclonePath\x12\x1d\n" +
	"\n" +
	"no_cleanup\x18\x11 \x01(\bR\tnoCleanup\x12*\n" +
	"\x11print_legacy_json\x18\x12 \x01(\bR\x0fprintLegacyJson\x123\n" +
	"\x16trust_local_git_config\x18\x13 \x01(\bR\x13trustLocalGitConfigB\f\n" +
	"\n" +
	"credential\"\xf2\x04\n" +
	"\x06GitLab\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x12\x16\n" +
	...
	"\x12remove_auth_in_url\x18\v \x01(\bR\x0fremoveAuthInUrl\x12\x1b\n" +
	"\tgroup_ids\x18\f \x03(\tR\bgroupIds\x12\x1d\n" +
	"\n" +
	"clone_path\x18\r \x01(\tR\tclonePath\x12\x1d\n" +
	"\n" +
	"no_cleanup\x18\x0e \x01(\bR\tnoCleanup\x12*\n" +
	"\x11print_legacy_json\x18\x0f \x01(\bR\x0fprintLegacyJsonB\f\n" +
	"\n" +
	"credential\"\xfb\b\n" +
	"\x06GitHub\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x127\n" +
	...
	"\x12remove_auth_in_url\x18\x15 \x01(\bR\x0fremoveAuthInUrl\x12\x1d\n" +
	"\n" +
	"clone_path\x18\x16 \x01(\tR\tclonePath\x12\x1d\n" +
	"\n" +
	"no_cleanup\x18\x17 \x01(\bR\tnoCleanup\x12!\n" +
	"\fignore_gists\x18\x18 \x01(\bR\vignoreGists\x12*\n" +
	"\x11print_legacy_json\x18\x19 \x01(\bR\x0fprintLegacyJson\x124\n" +
	"\x16scan_all_installations\x18\x1a \x01(\bR\x14scanAllInstallations\x12)\n" +
	"\x10exclude_archived\x18\x1b \x01(\bR\x0fexcludeArchivedB\f\n" +
	"\n" +
	"credential\"\xe4\x01\n" +
	...
	"credential\"\xce\x01\n" +
	"\vGoogleDrive\x12%\n" +
	"\rrefresh_token\x18\x01 \x01(\tH\x00R\frefreshToken\x12,\n" +
	"\x11use_token_service\x18\x02 \x01(\bH\x00R\x0fuseTokenService\x12+\n" +
	"\x05oauth\x18\x03 \x01(\v2\x13.credentials.Oauth2H\x00R\x05oauth\x12/\n" +
	"\x03dwd\x18\x04 \x01(\v2\x1b.credentials.GoogleDriveDWDH\x00R\x03dwdB\f\n" +
	"\n" +
	"credential\"\xf9\x06\n" +
	"\vHuggingface\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x12\x16\n" +
	...
	"includePrs\x12\x18\n" +
	"\abuckets\x18\x14 \x03(\tR\abuckets\x12%\n" +
	"\x0eignore_buckets\x18\x15 \x03(\tR\rignoreBuckets\x12'\n" +
	"\x0finclude_buckets\x18\x16 \x03(\tR\x0eincludeBuckets\x12(\n" +
	"\x10skip_all_buckets\x18\x17 \x01(\bR\x0eskipAllBucketsB\f\n" +
	"\n" +
	"credential\"\xcc\x03\n" +
	"\x04JIRA\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x127\n" +
	...
	"\x18insecure_skip_verify_tls\x18\b \x01(\bR\x15insecureSkipVerifyTls\x12J\n" +
	"\x11installation_type\x18\t \x01(\x0e2\x1d.sources.JiraInstallationTypeR\x10installationTypeB\f\n" +
	"\n" +
	"credential\"s\n" +
	...
	" \x01(\bR\x0ebestEffortScan\x12!\n" +
	"\fbearer_token\x18\v \x01(\tR\vbearerToken\"\xde\x01\n" +
	"\x06Sentry\x12\x1a\n" +
	...
	"\x0eJSONEnumerator\x12\x14\n" +
	"\x05paths\x18\x01 \x03(\tR\x05paths*\xc4\t\n" +
	"\n" +
	"SourceType\x12\x1d\n" +
	...
	"\x1cSOURCE_TYPE_SLACK_CONTINUOUS\x10)\x12\x1f\n" +
	"\x1bSOURCE_TYPE_JSON_ENUMERATOR\x10**G\n" +
	"\x19BitbucketInstallationType\x12\x0e\n" +
	"\n" +
	"AUTODETECT\x10\x00\x12\t\n" +
	"\x05CLOUD\x10\x01\x12\x0f\n" +
	"\vDATA_CENTER\x10\x02*\x87\x01\n" +
	"\x14JiraInstallationType\x12%\n" +
	"!JIRA_INSTALLATION_TYPE_AUTODETECT\x10\x00\x12 \n" +
	"\x1cJIRA_INSTALLATION_TYPE_CLOUD\x10\x01\x12&\n" +
	"\"JIRA_INSTALLATION_TYPE_DATA_CENTER\x10\x02B;Z9github.com/trufflesecurity/trufflehog/v3/pkg/pb/sourcespbb\x06proto3"
