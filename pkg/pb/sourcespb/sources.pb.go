...
type AzureStorage struct {
	...
	//	*AzureStorage_AccessToken
	//	*AzureStorage_SharedKey
	...
	StorageTables     []string                  `protobuf:"bytes,6,rep,name=storage_tables,json=storageTables,proto3" json:"storage_tables,omitempty"`
	StorageQueues     []string                  `protobuf:"bytes,7,rep,name=storage_queues,json=storageQueues,proto3" json:"storage_queues,omitempty"`
	StorageFileShares []string                  `protobuf:"bytes,8,rep,name=storage_file_shares,json=storageFileShares,proto3" json:"storage_file_shares,omitempty"`
}
...
func (x *AzureStorage) GetAccessToken() *credentialspb.AzureAccessToken {
	if x, ok := x.GetCredential().(*AzureStorage_AccessToken); ok {
		return x.AccessToken
	}
	return nil
}

func (x *AzureStorage) GetSharedKey() *credentialspb.KeySecret {
	if x, ok := x.GetCredential().(*AzureStorage_SharedKey); ok {
		return x.SharedKey
	}
	return nil
}
...
func (x *AzureStorage) GetStorageTables() []string {
	if x != nil {
		return x.StorageTables
	}
	return nil
}

func (x *AzureStorage) GetStorageQueues() []string {
	if x != nil {
		return x.StorageQueues
	}
	return nil
}

func (x *AzureStorage) GetStorageFileShares() []string {
	if x != nil {
		return x.StorageFileShares
	}
	return nil
}
...
type AzureStorage_AccessToken struct {
	AccessToken *credentialspb.AzureAccessToken `protobuf:"bytes,2,opt,name=access_token,json=accessToken,proto3,oneof"`
}

type AzureStorage_SharedKey struct {
	SharedKey *credentialspb.KeySecret `protobuf:"bytes,3,opt,name=shared_key,json=sharedKey,proto3,oneof"`
}
...
func (*AzureStorage_AccessToken) isAzureStorage_Credential() {}

func (*AzureStorage_SharedKey) isAzureStorage_Credential() {}
...
var file_sources_proto_rawDesc = []byte{
	...
	0x69, 0x61, 0x6c, 0x22, 0xbf, 0x03, 0x0a, 0x0c, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x53, 0x74, 0x6f,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x86, 0x03, 0x0a, 0x02, 0x53, 0x33, 0x12, 0x37, 0x0a,
	...
	0x61, 0x6c, 0x2a, 0x9e, 0x07, 0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70,
	...
	0x49, 0x10, 0x20, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_sources_proto_goTypes = []interface{}{
	...
	(*credentialspb.AzureAccessToken)(nil),      // 36: credentials.AzureAccessToken
...
var file_sources_proto_depIdxs = []int32{
	...
	36, // 4: sources.AzureStorage.access_token:type_name -> credentials.AzureAccessToken
	37, // 5: sources.AzureStorage.shared_key:type_name -> credentials.KeySecret
	35, // 6: sources.AzureStorage.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 7: sources.Bitbucket.oauth:type_name -> credentials.Oauth2
	34, // 8: sources.Bitbucket.basic_auth:type_name -> credentials.BasicAuth
	35, // 9: sources.Confluence.unauthenticated:type_name -> credentials.Unauthenticated
	34, // 10: sources.Confluence.basic_auth:type_name -> credentials.BasicAuth
	1,  // 11: sources.Confluence.spaces_scope:type_name -> sources.Confluence.GetAllSpacesScope
	35, // 12: sources.Docker.unauthenticated:type_name -> credentials.Unauthenticated
	34, // 13: sources.Docker.basic_auth:type_name -> credentials.BasicAuth
	37, // 14: sources.ECR.access_key:type_name -> credentials.KeySecret
	35, // 15: sources.GCS.unauthenticated:type_name -> credentials.Unauthenticated
	39, // 16: sources.GCS.adc:type_name -> credentials.CloudEnvironment
	38, // 17: sources.GCS.oauth:type_name -> credentials.Oauth2
	34, // 18: sources.Git.basic_auth:type_name -> credentials.BasicAuth
	35, // 19: sources.Git.unauthenticated:type_name -> credentials.Unauthenticated
	40, // 20: sources.Git.ssh_auth:type_name -> credentials.SSHAuth
	38, // 21: sources.GitLab.oauth:type_name -> credentials.Oauth2
	34, // 22: sources.GitLab.basic_auth:type_name -> credentials.BasicAuth
	41, // 23: sources.GitHub.github_app:type_name -> credentials.GitHubApp
	35, // 24: sources.GitHub.unauthenticated:type_name -> credentials.Unauthenticated
	34, // 25: sources.GitHub.basic_auth:type_name -> credentials.BasicAuth
	34, // 26: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	35, // 27: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 28: sources.JIRA.oauth:type_name -> credentials.Oauth2
	35, // 29: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	35, // 30: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	37, // 31: sources.S3.access_key:type_name -> credentials.KeySecret
	35, // 32: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	39, // 33: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	42, // 34: sources.S3.session_token:type_name -> credentials.AWSSessionTokenSecret
	43, // 35: sources.Slack.tokens:type_name -> credentials.SlackTokens
	34, // 36: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	35, // 37: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	34, // 38: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	44, // 39: sources.Jenkins.header:type_name -> credentials.Header
	45, // 40: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	38, // 41: sources.Teams.oauth:type_name -> credentials.Oauth2
	35, // 42: sources.Forager.unauthenticated:type_name -> credentials.Unauthenticated
	46, // 43: sources.Forager.since:type_name -> google.protobuf.Timestamp
	43, // 44: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
	38, // 45: sources.Sharepoint.oauth:type_name -> credentials.Oauth2
	38, // 46: sources.AzureRepos.oauth:type_name -> credentials.Oauth2
...
func file_sources_proto_init() {
	...
	file_sources_proto_msgTypes[2].OneofWrappers = []interface{}{
		...
		(*AzureStorage_AccessToken)(nil),
		(*AzureStorage_SharedKey)(nil),
