...
const (
	...
	SourceType_SOURCE_TYPE_HTTPX                      SourceType = 44
)
...
// Httpx configures a scan of ProjectDiscovery httpx JSONL output. Only the
// response body fields of each record are scanned.
type Httpx struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// paths are the httpx JSONL files to scan. "-" reads from stdin.
	Paths []string `protobuf:"bytes,1,rep,name=paths,proto3" json:"paths,omitempty"`
	// base64_body indicates bodies are base64-encoded (httpx -irrb).
	Base64Body bool `protobuf:"varint,2,opt,name=base64_body,json=base64Body,proto3" json:"base64_body,omitempty"`
	// include_headless_body additionally scans the headless_body field.
	IncludeHeadlessBody bool `protobuf:"varint,3,opt,name=include_headless_body,json=includeHeadlessBody,proto3" json:"include_headless_body,omitempty"`
	// max_record_bytes caps the size of a single JSONL record; larger records are
	// skipped. Zero means use the source default.
	MaxRecordBytes int64 `protobuf:"varint,4,opt,name=max_record_bytes,json=maxRecordBytes,proto3" json:"max_record_bytes,omitempty"`
}
...
func (x *Httpx) GetBase64Body() bool {
	if x != nil {
		return x.Base64Body
	}
	return false
...
func (x *Httpx) GetIncludeHeadlessBody() bool {
	if x != nil {
		return x.IncludeHeadlessBody
	}
	return false
}

func (x *Httpx) GetMaxRecordBytes() int64 {
	if x != nil {
...
var file_sources_proto_rawDesc = []byte{
	...
	,
	...
	0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x45, 0x52, 0x41, 0x54, 0x4f, 0x52, 0x10, 0x2a, 0x12, 0x23, 0x0a,
	0x1f, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x41, 0x57, 0x53,
	0x5f, 0x53, 0x45, 0x43, 0x52, 0x45, 0x54, 0x53, 0x5f, 0x4d, 0x41, 0x4e, 0x41, 0x47, 0x45, 0x52,
	0x10, 0x2b, 0x12, 0x15, 0x0a, 0x11, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x48, 0x54, 0x54, 0x50, 0x58, 0x10, 0x2c, 0x2a, 0x47, 0x0a, 0x19, 0x42, 0x69, 0x74,
	...
	,
...
var file_sources_proto_goTypes = []interface{}{
	...
	(*credentialspb.BitbucketApiToken)(nil),     // 51: credentials.BitbucketApiToken
	(*credentialspb.KeySecret)(nil),             // 52: credentials.KeySecret
	(*credentialspb.CloudEnvironment)(nil),      // 53: credentials.CloudEnvironment
	(*credentialspb.SSHAuth)(nil),               // 54: credentials.SSHAuth
	(*credentialspb.GitHubApp)(nil),             // 55: credentials.GitHubApp
	(*credentialspb.GoogleDriveDWD)(nil),        // 56: credentials.GoogleDriveDWD
	(*credentialspb.AWSSessionTokenSecret)(nil), // 57: credentials.AWSSessionTokenSecret
	(*credentialspb.SlackTokens)(nil),           // 58: credentials.SlackTokens
	(*credentialspb.Header)(nil),                // 59: credentials.Header
	(*credentialspb.ClientCredentials)(nil),     // 60: credentials.ClientCredentials
...
var file_sources_proto_depIdxs = []int32{
	...
	51, // 8: sources.Bitbucket.api_token:type_name -> credentials.BitbucketApiToken
	1,  // 9: sources.Bitbucket.installation_type:type_name -> sources.BitbucketInstallationType
	49, // 10: sources.Confluence.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 11: sources.Confluence.basic_auth:type_name -> credentials.BasicAuth
	3,  // 12: sources.Confluence.spaces_scope:type_name -> sources.Confluence.GetAllSpacesScope
	49, // 13: sources.Docker.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 14: sources.Docker.basic_auth:type_name -> credentials.BasicAuth
	52, // 15: sources.ECR.access_key:type_name -> credentials.KeySecret
	49, // 16: sources.GCS.unauthenticated:type_name -> credentials.Unauthenticated
	53, // 17: sources.GCS.adc:type_name -> credentials.CloudEnvironment
	50, // 18: sources.GCS.oauth:type_name -> credentials.Oauth2
	48, // 19: sources.Git.basic_auth:type_name -> credentials.BasicAuth
	49, // 20: sources.Git.unauthenticated:type_name -> credentials.Unauthenticated
	54, // 21: sources.Git.ssh_auth:type_name -> credentials.SSHAuth
	50, // 22: sources.GitLab.oauth:type_name -> credentials.Oauth2
	48, // 23: sources.GitLab.basic_auth:type_name -> credentials.BasicAuth
	55, // 24: sources.GitHub.github_app:type_name -> credentials.GitHubApp
	49, // 25: sources.GitHub.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 26: sources.GitHub.basic_auth:type_name -> credentials.BasicAuth
	55, // 27: sources.GitHubRealtime.github_app:type_name -> credentials.GitHubApp
	49, // 28: sources.GitHubRealtime.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 29: sources.GitHubRealtime.basic_auth:type_name -> credentials.BasicAuth
	50, // 30: sources.GoogleDrive.oauth:type_name -> credentials.Oauth2
	56, // 31: sources.GoogleDrive.dwd:type_name -> credentials.GoogleDriveDWD
	49, // 32: sources.Huggingface.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 33: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	49, // 34: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	50, // 35: sources.JIRA.oauth:type_name -> credentials.Oauth2
	2,  // 36: sources.JIRA.installation_type:type_name -> sources.JiraInstallationType
	49, // 37: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	49, // 38: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	52, // 39: sources.S3.access_key:type_name -> credentials.KeySecret
	49, // 40: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	53, // 41: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	57, // 42: sources.S3.session_token:type_name -> credentials.AWSSessionTokenSecret
	58, // 43: sources.Slack.tokens:type_name -> credentials.SlackTokens
	48, // 44: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	49, // 45: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 46: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	59, // 47: sources.Jenkins.header:type_name -> credentials.Header
	49, // 48: sources.Jenkins.unauthenticated:type_name -> credentials.Unauthenticated
	60, // 49: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	50, // 50: sources.Teams.oauth:type_name -> credentials.Oauth2
	49, // 51: sources.Forager.unauthenticated:type_name -> credentials.Unauthenticated
	61, // 52: sources.Forager.since:type_name -> google.protobuf.Timestamp
	58, // 53: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
	50, // 54: sources.Sharepoint.oauth:type_name -> credentials.Oauth2
	50, // 55: sources.AzureRepos.oauth:type_name -> credentials.Oauth2
	49, // 56: sources.Postman.unauthenticated:type_name -> credentials.Unauthenticated
	59, // 57: sources.Webhook.header:type_name -> credentials.Header
