...
var file_sources_proto_goTypes = []interface{}{
	...
	(*credentialspb.GitHubApp)(nil),         // 34: credentials.GitHubApp
	(*credentialspb.CloudEnvironment)(nil),  // 35: credentials.CloudEnvironment
	(*credentialspb.SlackTokens)(nil),       // 36: credentials.SlackTokens
	(*credentialspb.Header)(nil),            // 37: credentials.Header
	(*credentialspb.ClientCredentials)(nil), // 38: credentials.ClientCredentials
...
var file_sources_proto_depIdxs = []int32{
	...
	32, // 13: sources.GitLab.oauth:type_name -> credentials.Oauth2
	30, // 14: sources.GitLab.basic_auth:type_name -> credentials.BasicAuth
	34, // 15: sources.GitHub.github_app:type_name -> credentials.GitHubApp
	31, // 16: sources.GitHub.unauthenticated:type_name -> credentials.Unauthenticated
	30, // 17: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	31, // 18: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	32, // 19: sources.JIRA.oauth:type_name -> credentials.Oauth2
	31, // 20: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	31, // 21: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	33, // 22: sources.S3.access_key:type_name -> credentials.KeySecret
	31, // 23: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	35, // 24: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	36, // 25: sources.Slack.tokens:type_name -> credentials.SlackTokens
	30, // 26: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	31, // 27: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	30, // 28: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	37, // 29: sources.Jenkins.header:type_name -> credentials.Header
	38, // 30: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	30, // 31: sources.Artifactory.basic_auth:type_name -> credentials.BasicAuth
	31, // 32: sources.PublicEventMonitoring.unauthenticated:type_name -> credentials.Unauthenticated
	39, // 33: sources.PublicEventMonitoring.since:type_name -> google.protobuf.Timestamp
	36, // 34: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
