...
var file_sources_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xf0, 0x02, 0x0a, 0x02, 0x53, 0x33, 0x12, 0x37, 0x0a,
	...
	0x74, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x6d, 0x61,
	0x78, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x0c, 0x0a, 0x0a, 0x63,
	...
	0xf1, 0x06, 0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d,
	...
	0x45, 0x5f, 0x43, 0x4f, 0x4e, 0x46, 0x4c, 0x55, 0x45, 0x4e, 0x43, 0x45, 0x10, 0x03, 0x12, 0x20,
	0x0a, 0x1c, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x44, 0x4f,
	0x43, 0x4b, 0x45, 0x52, 0x48, 0x55, 0x42, 0x5f, 0x49, 0x4d, 0x41, 0x47, 0x45, 0x53, 0x10, 0x04,
	...
	0x44, 0x10, 0x1e, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_sources_proto_depIdxs = []int32{
	...
	32, // 21: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	33, // 22: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	34, // 23: sources.JIRA.oauth:type_name -> credentials.Oauth2
	33, // 24: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	33, // 25: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	35, // 26: sources.S3.access_key:type_name -> credentials.KeySecret
	33, // 27: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	36, // 28: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	39, // 29: sources.S3.session_token:type_name -> credentials.AWSSessionTokenSecret
	40, // 30: sources.Slack.tokens:type_name -> credentials.SlackTokens
	32, // 31: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	33, // 32: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	32, // 33: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	41, // 34: sources.Jenkins.header:type_name -> credentials.Header
	42, // 35: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	34, // 36: sources.Teams.oauth:type_name -> credentials.Oauth2
	32, // 37: sources.Artifactory.basic_auth:type_name -> credentials.BasicAuth
	33, // 38: sources.PublicEventMonitoring.unauthenticated:type_name -> credentials.Unauthenticated
	43, // 39: sources.PublicEventMonitoring.since:type_name -> google.protobuf.Timestamp
	40, // 40: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
	34, // 41: sources.Sharepoint.oauth:type_name -> credentials.Oauth2
