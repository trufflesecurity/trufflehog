...
type PublicEventMonitoring struct {
	...
	EventType isPublicEventMonitoring_EventType `protobuf_oneof:"event_type"`
...
func (m *PublicEventMonitoring) GetEventType() isPublicEventMonitoring_EventType {
	if m != nil {
		return m.EventType
	}
	return nil
...
func (x *PublicEventMonitoring) GetGithub() string {
	if x, ok := x.GetEventType().(*PublicEventMonitoring_Github); ok {
		return x.Github
	}
	return ""
}

func (x *PublicEventMonitoring) GetDepth() int32 {
	if x != nil {
		return x.Depth
	}
	return 0
...
type isPublicEventMonitoring_EventType interface {
	isPublicEventMonitoring_EventType()
}

type PublicEventMonitoring_Github struct {
	Github string `protobuf:"bytes,9,opt,name=github,proto3,oneof"`
}

func (*PublicEventMonitoring_Github) isPublicEventMonitoring_EventType() {}
...
var file_source_metadata_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x69, 0x74, 0x79, 0x22, 0x99, 0x02, 0x0a, 0x15, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63,
	...
	0x69, 0x6e, 0x65, 0x12, 0x18, 0x0a, 0x06, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x12, 0x14, 0x0a,
	0x05, 0x64, 0x65, 0x70, 0x74, 0x68, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x64, 0x65,
	0x70, 0x74, 0x68, 0x42, 0x0c, 0x0a, 0x0a, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x22, 0x87, 0x0a, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2e,
	...
	0x63, 0x65, 0x12, 0x3a, 0x0a, 0x09, 0x64, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x68, 0x75, 0x62, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x68, 0x75,
	0x62, 0x48, 0x00, 0x52, 0x09, 0x64, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x68, 0x75, 0x62, 0x12, 0x28,
	...
	0x69, 0x6e, 0x67, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x43, 0x5a, 0x41, 0x67,
