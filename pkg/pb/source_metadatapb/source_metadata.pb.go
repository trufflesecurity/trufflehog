...
func (x *Logstash) GetIndex() string {
	if x != nil {
		return x.Index
	}
	return ""
...
func (x *Logstash) GetDocumentId() string {
	if x != nil {
		return x.DocumentId
	}
	return ""
...
func (x *Logstash) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
func (x *MetaData) GetLogstash() *Logstash {
	if x, ok := x.GetData().(*MetaData_Logstash); ok {
		return x.Logstash
	}
	return nil
}
...
type MetaData_Logstash struct {
	Logstash *Logstash `protobuf:"bytes,31,opt,name=logstash,proto3,oneof"`
}
...
func (*MetaData_Logstash) isMetaData_Data() {}
...
var file_source_metadata_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x22, 0x5f, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x73, 0x74, 0x61, 0x73, 0x68, 0x12, 0x14,
	...
	0x61, 0x6d, 0x70, 0x22, 0xf2, 0x0c, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61,
	...
	0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x12, 0x37, 0x0a, 0x08, 0x6c, 0x6f, 0x67, 0x73, 0x74,
	0x61, 0x73, 0x68, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x4c, 0x6f, 0x67, 0x73,
	0x74, 0x61, 0x73, 0x68, 0x48, 0x00, 0x52, 0x08, 0x6c, 0x6f, 0x67, 0x73, 0x74, 0x61, 0x73, 0x68,
...
var file_source_metadata_proto_goTypes = []interface{}{
	...
	(*Logstash)(nil),              // 32: source_metadata.Logstash
...
var file_source_metadata_proto_depIdxs = []int32{
	...
	32, // 38: source_metadata.MetaData.logstash:type_name -> source_metadata.Logstash
