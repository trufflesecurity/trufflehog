...
// Validate checks the field values on BasicAuthWithHeader with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *BasicAuthWithHeader) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BasicAuthWithHeader with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// BasicAuthWithHeaderMultiError, or nil if none found.
func (m *BasicAuthWithHeader) ValidateAll() error {
	return m.validate(true)
}

func (m *BasicAuthWithHeader) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, BasicAuthWithHeaderValidationError{
					field:  "Header",
		...
		if err := v.Validate(); err != nil {
			return BasicAuthWithHeaderValidationError{
				field:  "Header",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return BasicAuthWithHeaderMultiError(errors)
	}
	return nil
}

// BasicAuthWithHeaderMultiError is an error wrapping multiple validation
// errors returned by BasicAuthWithHeader.ValidateAll() if the designated
// constraints aren't met.
type BasicAuthWithHeaderMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BasicAuthWithHeaderMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m BasicAuthWithHeaderMultiError) AllErrors() []error { return m }

// BasicAuthWithHeaderValidationError is the validation error returned by
// BasicAuthWithHeader.Validate if the designated constraints aren't met.
type BasicAuthWithHeaderValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BasicAuthWithHeaderValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BasicAuthWithHeaderValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BasicAuthWithHeaderValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BasicAuthWithHeaderValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BasicAuthWithHeaderValidationError) ErrorName() string {
	return "BasicAuthWithHeaderValidationError"
}

// Error satisfies the builtin error interface
func (e BasicAuthWithHeaderValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sBasicAuthWithHeader.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = BasicAuthWithHeaderValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = BasicAuthWithHeaderValidationError{}
