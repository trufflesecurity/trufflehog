...
// Validate checks the field values on VerifyRequestBody with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *VerifyRequestBody) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on VerifyRequestBody with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// VerifyRequestBodyMultiError, or nil if none found.
func (m *VerifyRequestBody) ValidateAll() error {
	return m.validate(true)
}

func (m *VerifyRequestBody) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return VerifyRequestBodyMultiError(errors)
	}

	return nil
}

// VerifyRequestBodyMultiError is an error wrapping multiple validation errors
// returned by VerifyRequestBody.ValidateAll() if the designated constraints
// aren't met.
type VerifyRequestBodyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m VerifyRequestBodyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m VerifyRequestBodyMultiError) AllErrors() []error { return m }

// VerifyRequestBodyValidationError is the validation error returned by
// VerifyRequestBody.Validate if the designated constraints aren't met.
type VerifyRequestBodyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e VerifyRequestBodyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e VerifyRequestBodyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e VerifyRequestBodyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e VerifyRequestBodyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e VerifyRequestBodyValidationError) ErrorName() string {
	return "VerifyRequestBodyValidationError"
}

// Error satisfies the builtin error interface
func (e VerifyRequestBodyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sVerifyRequestBody.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = VerifyRequestBodyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = VerifyRequestBodyValidationError{}
