...
type CustomRegex struct {
	...
	Validations           *ValidationConfig `protobuf:"bytes,11,opt,name=validations,proto3" json:"validations,omitempty"`
}
...
func (x *CustomRegex) GetValidations() *ValidationConfig {
	if x != nil {
...
var file_custom_detectors_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x73, 0x22, 0xb2, 0x04, 0x0a, 0x0b, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65,
	...
	0x65, 0x67, 0x65, 0x78, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x44, 0x0a, 0x0b, 0x76, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e,
	...
	0x67, 0x52, 0x0b, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x38,
	0x0a, 0x0a, 0x52, 0x65, 0x67, 0x65, 0x78, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
...
var file_custom_detectors_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_custom_detectors_proto_depIdxs = []int32{
	...
	3, // 3: custom_detectors.CustomRegex.validations:type_name -> custom_detectors.ValidationConfig
