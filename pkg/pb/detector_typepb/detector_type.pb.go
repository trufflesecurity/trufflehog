...
const file_detector_type_proto_rawDesc = "" +
	...
	"\tReCAPTCHA\x10F\x12\x14\n" +
	"\fGoogleApiKey\x10G\x1a\x02\b\x01\x12\n" +
	"\n" +
	...
	"\n" +
	"\x05Nylas\x10\xe9\x04\x12\x11\n" +
	"\bSquareup\x10\xea\x04\x1a\x02\b\x01\x12\x0e\n" +
	...
	"\x03JWT\x10\x8f\b\x12\x10\n" +
	"\vOpenAIAdmin\x10\x90\b\x12\x17\n" +
	"\x12GoogleGeminiAPIKey\x10\x91\b\x12\x1e\n" +
	"\x19ArtifactoryReferenceToken\x10\x92\b\x12\x12\n" +
	"\rDatadogApikey\x10\x93\b\x12\x11\n" +
	"\fShopifyOAuth\x10\x94\b\x12\x18\n" +
	"\x13BitbucketDataCenter\x10\x95\b\x12\x16\n" +
	"\x11JiraDataCenterPAT\x10\x96\b\x12\x19\n" +
	"\x14ConfluenceDataCenter\x10\x97\b\x12\x0f\n" +
	"\n" +
	"Cloudinary\x10\x98\b\x12\r\n" +
	"\bPinecone\x10\x99\b\x12\x11\n" +
	"\fGitLabOauth2\x10\x9a\b\x12\x10\n" +
	"\vSpectralOps\x10\x9b\b\x12\x0f\n" +
	"\n" +
	"AWSAppSync\x10\x9c\b\x12\x15\n" +
	"\x10BrainTrustApiKey\x10\x9d\b\x12\x15\n" +
	"\x10PgAnalyzeReadKey\x10\x9e\b\x12\x10\n" +
	"\vRedHatPyxis\x10\x9f\b\x12\x12\n" +
	"\rOctopusDeploy\x10\xa0\b\x12\x0f\n" +
	"\n" +
	"OpenRouter\x10\xa1\b\x12\x1e\n" +
	"\x19NewRelicInsightsInsertKey\x10\xa2\b\x12\x10\n" +
	"\vDuffelToken\x10\xa3\b\x12\v\n" +
	"\x06Shippo\x10\xa4\b\x12\x1d\n" +
...
var (
	...
	file_detector_type_proto_rawDescData []byte
)

func file_detector_type_proto_rawDescGZIP() []byte {
	file_detector_type_proto_rawDescOnce.Do(func() {
		file_detector_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_detector_type_proto_rawDesc), len(file_detector_type_proto_rawDesc)))
	})
	return file_detector_type_proto_rawDescData
}

var file_detector_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_detector_type_proto_goTypes = []any{
...
func file_detector_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_detector_type_proto_rawDesc), len(file_detector_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
