	...
	tests := []struct {
		...
		},
		{
			...
			input: `
				<com.cloudbees.plugins.credentials.impl.StringCredentialsImpl>
  					<scope>GLOBAL</scope>
  					<id>{teleriklicensekey}</id>
  					<secret>{teleriklicensekey AQAAABAAA 5iqW7gKQVXvwnykF9xAVfenemmnUJznI}</secret>
		...
		},
		{
			...
			input: `
				...
				[DEBUG] Using teleriklicensekey Key=xuQIeWFVEp8k8Uu9FwPx6X5C8IViOe1o
				[INFO] Response received: 200 OK
			`,
