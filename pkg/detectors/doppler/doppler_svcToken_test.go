...
func TestDopplerSvcToken_FromChunk(t *testing.T) {
	...
	secret := testSecrets.MustGetField("DOPPLER_SVC")
	inactiveSecret := testSecrets.MustGetField("DOPPLER_SVC_INACTIVE")
...
func BenchmarkFromData1(benchmark *testing.B) {
	ctx := context.Background()
	s := Scanner{}
