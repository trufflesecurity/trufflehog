...
func TestDopplerAuditToken_FromChunk(t *testing.T) {
	...
	secret := testSecrets.MustGetField("DOPPLER_AUDIT")
	inactiveSecret := testSecrets.MustGetField("DOPPLER_AUDIT_INACTIVE")
