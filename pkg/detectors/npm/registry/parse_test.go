...
func TestNpm_KnownRegistryPat(t *testing.T) {
	cases := map[Type]map[string][]string{
		...
		artifactoryCloud: {
			...
			"//trfhog.jfrog.io/trfhog/api/npm/npm/:_authToken=e7da2cb5-b625-4aa1-8baf-291a8dfd037d":              {"//", "trfhog.jfrog.io/trfhog/api/npm/npm"},
		},
		nexusRepo2: {
...
- name: NPM_PUBLISH_TOKEN
  ...
  value: "NpmToken.b5505337-ffb2-3fac-8b3a-fcd81b8bb8fb"`: {"http://", "nexus3.my-company.tk:8081/repository/npm-releases"},
		...
		azure: {
			...
			"//tso-na.pkgs.visualstudio.com/7bc545d8-bf9c-477e-bb91-17a982c30c2e/_packaging/feed/npm/registry/": {"//", "tso-na.pkgs.visualstudio.com/7bc545d8-bf9c-477e-bb91-17a982c30c2e/_packaging/feed/npm/registry"},
...
func TestNpm_ParseKnownRegistryUri(t *testing.T) {
	cases := map[Type]struct {
		...
		npm: {
			data: `//registry.yarnpkg.org/:_authToken=e7da2cb5-b625-4aa1-8baf-291a8dfd037d`,
			uri:  "//registry.yarnpkg.org",
			expected: &Info{
				Scheme: HttpsScheme,
