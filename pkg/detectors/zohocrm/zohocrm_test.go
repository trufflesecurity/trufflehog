...
func TestZohocrm_Pattern(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			input: "zoho crm token = '1000.1fa6966eafbb115624baa4103269e50e.e57d155232227b4e41fa7dd2b88dd4d4'",
			want:  []string{"1000.1fa6966eafbb115624baa4103269e50e.e57d155232227b4e41fa7dd2b88dd4d4"},
		},
		{
			name:  "typical pattern - ignore duplicate",
			input: "zoho crm token = '1000.1fa6966eafbb115624baa4103269e50e.e57d155232227b4e41fa7dd2b88dd4d4 | 1000.1fa6966eafbb115624baa4103269e50e.e57d155232227b4e41fa7dd2b88dd4d4'",
			want:  []string{"1000.1fa6966eafbb115624baa4103269e50e.e57d155232227b4e41fa7dd2b88dd4d4"},
		},
		{
			name:  "invalid pattern",
			input: "zoho crm = '1000.4h081cd984199c4927700ac6fcc438cf.038a31c1b209855e0674898868f36aff'",
			want:  []string{},
		},
	}
