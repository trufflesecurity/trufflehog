...
func (s Scanner) FromData(ctx context.Context, verify bool, data []byte) (results []detectors.Result, err error) {
	...
	for match := range uniqueMatches {
		s1 := detectors.Result{
			...
			Raw:          []byte(match),
			Description:  "Atlassian provides tools for software development, project management, and content management. Atlassian API keys can be used to access and manage these tools and services.",
