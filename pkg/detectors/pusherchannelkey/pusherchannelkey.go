		...
		for _, keyMatch := range keyMatches {
			...
			for _, secretMatch := range secretMatches {
				...
				if verify {
					...
					md5Hash := hex.EncodeToString(_bodyMD5.Sum(nil))
					...
					md5Str := "https://api-ap1.pusher.com/apps/" + resappMatch + "/events?auth_key=" + reskeyMatch + "&auth_signature=" + signature + "&auth_timestamp=" + timestamp + "&auth_version=1.0&body_md5=" + md5Hash
