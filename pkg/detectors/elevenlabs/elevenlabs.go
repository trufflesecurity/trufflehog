...
var (
	...
	// elevenlabs tokens are added with the header xi-api-key and the convention XI_API_KEY is used in the code.
	keyPat = regexp.MustCompile(detectors.PrefixRegex([]string{"elevenlabs", "xi"}) + `\b(sk_[0-9a-zA-Z]{48})\b`)
)

// Keywords are used for efficiently pre-filtering chunks.
// Use identifiers in the secret preferably, or the provider name.
func (s Scanner) Keywords() []string {
	return []string{"elevenlabs", "xi"}
}
