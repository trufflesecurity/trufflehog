...
func TestCoze_FromData(t *testing.T) {
	...
	activeToken := testSecrets.MustGetField("COZE")
	inactiveToken := testSecrets.MustGetField("COZE_INACTIVE")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Fatalf("Coze.FromData() error = %v, wantErr %v", err, tt.wantErr)
			}
