...
var (
	...
	keyPat        = regexp.MustCompile(`\b(sk-or-v1-[a-f0-9]{64})\b`)
)
...
func (s Scanner) Description() string {
	return "OpenRouter provides unified API access to multiple LLM providers. API keys can be used to access various AI models."
}
