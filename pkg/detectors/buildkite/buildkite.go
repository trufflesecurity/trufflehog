...
// Make sure that the Scanner accomplishes the interface at compile time.
var _ detectors.Detector = (*Scanner)(nil)
var _ detectors.Versioner = (*Scanner)(nil)

var (
	client = common.SaneHttpClient()
	keyPat = regexp.MustCompile(detectors.PrefixRegex([]string{"buildkite"}) + `\b([0-9a-z]{40})\b`)
)

func (s Scanner) Keywords() [][]byte {
	return [][]byte{[]byte("buildkite")}
}
