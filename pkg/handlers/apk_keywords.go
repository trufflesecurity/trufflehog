...
// Note: If pkg/engine/defaults.go lived outside of the engine package, we wouldn't need this file.
// this is due to circular import issues related to importing the engine package here.
func DefaultDetectorKeywords() map[string]struct{} {
	...
	// Get all Keywords() from each detector
	...
	// Remove exclusions from the default keyword list
	for _, exclusion := range exclusions {
		delete(keywords, strings.ToLower(exclusion))
	}
	return keywords
}
