...
type BufferedReaderSeeker struct {
	...
	// and to optimize subsequent reads directly from the underlying reader. This helps avoid excessive memory
	// usage while still providing the necessary functionality for initial detection operations.
