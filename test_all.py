...
class TestStringMethods(unittest.TestCase):
    ...
    def test_shannon(self):
        ...
        self.assertGreater(truffleHog.shannon_entropy(random_stringB64, truffleHog.BASE64_CHARS), 6)
        self.assertGreater(truffleHog.shannon_entropy(random_stringHex, truffleHog.HEX_CHARS), 4)
